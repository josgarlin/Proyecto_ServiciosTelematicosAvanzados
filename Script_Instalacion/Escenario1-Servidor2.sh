...
# Configuracion del equiso Servidor 2 DHCP
...
${COPIAR} ${ESCENARIO1}/Servidor2/ifcfg-eth1 ${ETC_DIR}/sysconfig/network-scripts/ifcfg-eth1

# Cambiar posible configuracion del servidor DHCP
${BORRAR} ${LIB_DIR}/dhclient/* >& /dev/nul

${COPIAR} ${ESCENARIO1}/Servidor2/dhcpd.conf ${ETC_DIR}/dhcp/dhcpd.conf
