...
# Configuracion del equiso Encaminador 1
...
${COPIAR} ${ESCENARIO2}/Encaminador1/ifcfg-eth1 ${ETC_DIR}/sysconfig/network-scripts/ifcfg-eth1
${COPIAR} ${ESCENARIO2}/Encaminador1/dhcrelay ${ETC_DIR}/sysconfig/dhcrelay
